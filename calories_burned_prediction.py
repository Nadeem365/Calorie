...
# Replace "seaborn" with a valid style or install seaborn
style.use("ggplot")
...
st.image("https://qph.cf2.quoracdn.net/main-qimg-6a2cc536195901592212b858925edfa6", use_column_width=True)
...
calories = pd.read_csv(r"E:\Navriti\Calorie\calories.csv")
exercise = pd.read_csv(r"E:\Navriti\Calorie\exercise.csv")
